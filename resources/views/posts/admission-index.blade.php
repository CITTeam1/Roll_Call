...
<div class="container-fluid" style="margin-top: 7%">
    <div class="row">
        ...
        <div class="col-xl-10">
            ...
            <h2 class="text-center"><b style="color: green;">IN</b></h2>
            @endif
            <br><br><br>
...
function findId(lid)
{
    ...
    if($.trim(lid) != '')
    {
        $.ajaxSetup({
          ...
          $('#admitId').val("");
        $.ajax({
            url: '/event/admit/{{$event->id}}/store',
            ...
            success: function (response) {
                ...
                switch(response[0])
                {
                    ...
                    $("<tr id=\""+response[1].id+"\"><td>"+response[1].admissions_lid+"</td><td>"+response[1].admissions_last_name+"</td><td>"+response[1].admissions_first_name+"</td><td>"+ptype+"</td><td>"+cD+"</td></tr>").prependTo($("#admitTable")).fadeIn();
